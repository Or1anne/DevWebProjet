...
def rapport():
    ...
    pdf.cell(40, 5, "Pseudo", 1, 0, align='C')
    pdf.cell(40, 5, "Nom", 1, 0, align='C')
    pdf.cell(40, 5, "Prénom", 1, 0, align='C')
    pdf.cell(30, 5, "Âge", 1, 0, align='C')
    pdf.cell(40, 5, "Rôle", 1, 1, align='C')

    pdf.set_font('Courier', size=8)
    for user in users:
        pdf.cell(40, 5, user.pseudo, 1, 0, 'C')
        pdf.cell(40, 5, user.lastname, 1, 0, 'C')
        pdf.cell(40, 5, user.firstname, 1, 0, 'C')
        pdf.cell(30, 5, str(user.age), 1, 0, 'C')
        pdf.cell(40, 5, user.role if user.role else "Non attribué", 1, 1, 'C')
    pdf.ln(5)
    ...
    pdf.cell(35, 5, "Nom de l'objet", 1, 0, align='C')
    pdf.cell(30, 5, "Type d'objet", 1, 0, align='C')
    pdf.cell(35, 5, "Référence", 1, 0, align='C')
    pdf.cell(35, 5, "Pièce assignée", 1, 0, align='C')
    pdf.cell(15,5, "Statut", 1, 0, align='C')
    pdf.cell(20,5, "Energie", 1, 0, align='C')
    pdf.cell(25,5, "Luminosité", 1, 1, align='C')

    pdf.set_font('Courier', size=8)
    for object in objects:
        pdf.cell(35, 5, object.nom, 1, 0, 'C')
        pdf.cell(30, 5, object.type, 1, 0, 'C')
        pdf.cell(35, 5, object.reference, 1, 0, 'C')
        pdf.cell(35, 5, object.room.nom if object.room else "Non assignée", 1, 0, 'C')
        pdf.cell(15, 5, object.status, 1, 0, 'C')
        pdf.cell(20, 5 , str(object.energy) + "Wh", 1, 0, 'C')
        pdf.cell(25, 5 , str(object.luminosity) + "Lm" if object.luminosity else "0 Lm", 1, 1, 'C')
    pdf.ln(5)
